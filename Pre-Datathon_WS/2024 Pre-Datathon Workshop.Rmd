...
UC$Time_of_Day <- factor(UC$Time_of_Day, levels=c("Early Morning", "Morning", "Afternoon", "Evening"))
...
### More tutorial videos from freeCodeCamp.org on YouTube

* <https://www.youtube.com/watch?v=_V8eKsto3Ug&t=4s>
